...
<nav class="navbar navbar-expand-md navbar-light">
		...
		<div class="collapse navbar-collapse" id="exCollapsingNavbar">
            <ul class="nav navbar-nav">
				...
				<li class="nav-item"><a href="principalEsp.jsp" class="nav-link">Principal Usuario Especial</a></li>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-5 col-md-offset-3">
				<div class="form-area">
					<form action="../RegistrarUsuarioEsp" class="form-horizontal" method="post">
